...
## Parent Portal API Data Structures

The parent portal returns pre-processed, human-friendly data:
...
{
  "id": 205634,
  "dateTimeFrom": "2026-02-24 08:00:00",
  "dateTimeTo": "2026-02-24 08:45:00",
  "subjectName": "edukacja wczesnoszkolna",
  "bgColor": "background-color: #006600;",
  "attendanceLabel": "Obecnosc",
  "isLocked": 1,
  "isCyclic": 1,
  "isCanceled": 0,
  "substitution": 0,
...
```json
{
  "percent": 80.14,
  "types": [
    {"label": "Obecnosc", "count": 432},
    {"label": "Nieobecnosc", "count": 18}
  ]
}
```
