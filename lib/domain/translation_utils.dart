...
String _translateSingleAttendanceName(String name) {
  return _lookupWithCase(name, {
    ...
    'nieobecność usprawiedliwiona': t.attendanceTypes.nieobecnoscUsprawiedliwiona,
    'nieobecność nieusprawiedliwiona': t.attendanceTypes.nieobecnoscNieusprawiedliwiona,
    ...
    'spóźnienie nieusprawiedliwione': t.attendanceTypes.spoznienieNieusprawiedliwione,
    ...
    'sprawdzane na innym wydarzeniu': t.attendanceTypes.sprawdzaneNaInnymWydarzeniu,
    ...
    'indywidualna organizacja nauki': t.attendanceTypes.indywidualnaOrganizacjaNauki,
