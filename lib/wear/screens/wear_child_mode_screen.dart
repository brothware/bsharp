...
class WearChildModeScreen extends ConsumerStatefulWidget {
  const WearChildModeScreen({super.key});

  @override
  ConsumerState<WearChildModeScreen> createState() =>
      _WearChildModeScreenState();
}

class _WearChildModeScreenState extends ConsumerState<WearChildModeScreen> {
