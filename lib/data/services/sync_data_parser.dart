...
class SyncDataParser {
  SyncData parse(Map<String, dynamic> data) {
    return SyncData(
      ...
      eventTypeTeachers: _parseList(
        data['EventTypeTeachers'],
        _parseEventTypeTeacher,
      ),
      eventTypeTerms: _parseList(data['EventTypeTerms'], _parseEventTypeTerm),
      ...
      markGroupGroups: _parseList(
        data['MarkGroupGroups'],
        _parseMarkGroupGroup,
      ),
      attendances: _parseList(data['Attendances'], _parseAttendance),
      attendanceTypes: _parseList(
        data['AttendanceTypes'],
        _parseAttendanceType,
      ),
    );
  }
  ...
  MarkKind _parseMarkKind(Map<String, dynamic> j) => MarkKind(
    ...
    defaultMarkDivisionGroupsId: j['default_mark_division_groups_id'] as int?,
  ...
  MarkGroupGroup _parseMarkGroupGroup(Map<String, dynamic> j) => MarkGroupGroup(
    id: _int(j, 'id'),
    markDivisionGroupsId: j['mark_division_groups_id'] as int?,
    name: _str(j, 'name'),
    parentId: j['parent_id'] as int?,
  ...
  AttendanceType _parseAttendanceType(Map<String, dynamic> j) => AttendanceType(
    id: _int(j, 'id'),
    name: _str(j, 'name'),
    abbr: _str(j, 'abbr'),
    style: j['style'] as String?,
    countAs: AttendanceCountAs.fromString(_str(j, 'count_as')),
    excuseStatus: AttendanceExcuseStatus.fromString(j['type'] as String?),
  );
